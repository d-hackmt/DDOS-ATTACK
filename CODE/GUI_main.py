...
button1 = tk.Button(root, text="LOGIN PAGE", command=log, width=20, height=1,font=('times', 20, ' bold '), bg="black", fg="white")
button1.place(x=200, y=190)

button2 = tk.Button(root, text="REGISTER PAGE",command=reg,width=20, height=1,font=('times', 20, ' bold '), bg="black", fg="white")
button2.place(x=200, y=300)

button3 = tk.Button(root, text="EXIT",command=window,width=20, height=1,font=('times', 20, ' bold '), bg="black", fg="white")
