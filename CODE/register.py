...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=600, bd=5, font=('times', 14, ' bold '),fg="black",bg="#CD6090")
frame_alpr.grid(row=0, column=0, sticky='nw')
...
cursor.execute("CREATE TABLE IF NOT EXISTS registration"
               "(Fullname TEXT, address TEXT, username TEXT, Email TEXT, Phoneno TEXT, AdharNo TEXT, password TEXT)")
db.commit()
...
def insert():
    ...
    elif((len(str(adhar)))<12 or len(str((adhar)))>12):
        ms.showinfo("Message", "Please Enter 12 digit adhar number")
    ...
    #     ms.showinfo("Message", "Please Enter gender")
        ...
        with conn:
            cursor = conn.cursor()
            cursor.execute(
                'INSERT INTO registration(Fullname, address, username, Email, AdharNo, PhoneNo, password) VALUES(?,?,?,?,?,?,?)',
                (fname, addr, un, adhar, email, mobile, pwd))
...
l1 = tk.Label(frame_alpr, text="__Registration Form__", font=("Times new roman", 30, "bold","italic"),bd=5, bg="#CD6090", fg="black")
l1.place(x=120, y=10)
...
l7 = tk.Label(frame_alpr, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bd=5,fg="black")
l7.place(x=100, y=350)
t6 = tk.Entry(frame_alpr, textvar=username, width=20, font=('', 15))
t6.place(x=300, y=350)

l8 = tk.Label(frame_alpr, text="Password :", width=12, font=("Times new roman", 15, "bold"),bd=5, fg="black")
l8.place(x=100, y=400)
t7 = tk.Entry(frame_alpr, textvar=password, width=20, font=('', 15), show="*")
t7.place(x=300, y=400)

l9 = tk.Label(frame_alpr, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"),bd=5, fg="black")
l9.place(x=100, y=450)

t8 = tk.Entry(frame_alpr, textvar=password1, width=20, font=('', 15), show="*")
t8.place(x=300, y=450)
